...
- [x] **مركز القيادة (Platform Control Dashboard)**
  - [x] شريط الفلاتر العلوي (النطاق، الفترة، الحالة)
  - [x] أزرار التحديث والتصدير (PDF/Excel)
  - [x] المؤشرات العامة للمنصة (6 بطاقات تحليلية):
    - المدارس المسجلة مع المؤشرات الفرعية
    - إجمالي الطلاب مع نسب النشاط
    - إجمالي المعلمين مع حالات الجداول
    - المستخدمون النشطون
    - الحصص اليوم
    - العمليات (Operations)
  - [x] مؤشرات الصحة (Health Tags): طبيعي، يحتاج متابعة، خطر
  - [x] نسب التغيير (Delta) مقارنة بالفترة السابقة

- [x] **نشاط المنصة اليومي (Daily Platform Activity)**
  - [x] Badge "مباشر" (Live)
  - [x] فلتر طريقة العرض (حسب الساعة، المدرسة، النشاط)
  - [x] منطقة الرسم البياني التفاعلي
  - [x] ملخص النشاط (الحصص، الحضور، الدرجات، المستخدمون)
  - [x] نسب التغيير من أمس

- [x] **الإجراءات السريعة (Quick Actions)**
  - [x] 6 أزرار كبيرة: إضافة مدرسة، إدارة المستخدمين، إدارة القواعد، مراقبة النظام، التقارير، الإعدادات
  - [x] وصف مختصر لكل زر
  - [x] Navigation صحيح لكل صفحة

- [x] **Wizard إنشاء مدرسة جديدة (4 خطوات)**
  - [x] الخطوة 1: بيانات المدرسة (الاسم، الشعار، الدولة، المدينة، العنوان)
  - [x] الخطوة 2: إعدادات التشغيل (اللغة، التقويم، نوع المدرسة، المرحلة)
  - [x] الخطوة 3: حساب مدير المدرسة (الاسم، الهاتف، البريد)
  - [x] الخطوة 4: مراجعة البيانات
  - [x] شاشة النجاح مع رسالة الترحيب
...
- [x] **لوحة العمليات الذكية السريعة (AI Operations Panel)**
  ...
  - [x] 8 بطاقات عمليات AI:
    ...
    - فحص جودة البيانات (Data Quality Scan)
    - تحليل الاستيراد (Import Analyzer)
    - فحص صحة المدارس (Tenant Health Check)
    - اقتراح إعدادات (Config Suggestion)
    - ملخص تنفيذي (Executive Summary)
    - منشئ التقارير (Report Builder)
    - مراجعة التنبيهات (Alerts Review)
  - [x] المهام المقترحة (AI Suggestions) مع الأولويات
  - [x] سجل آخر العمليات الذكية
  - [x] المساعد الذكي المصغر (Mini AI Assistant)

- [x] **تحديث القائمة الجانبية لمدير المنصة**
  - [x] مركز القيادة
  - [x] إدارة المدارس
  - [x] إدارة المستخدمين
  - [x] طلبات المعلمين
